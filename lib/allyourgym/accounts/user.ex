defmodule Allyourgym.Accounts.User do
  @moduledoc """
  This module defines the User schema and changesets for user registration,
  email changes, password changes, and account confirmation.
  """
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Allyourgym.Repo)
  ...
  """
  def valid_password?(%Allyourgym.Accounts.User{hashed_password: hashed_password}, password)
