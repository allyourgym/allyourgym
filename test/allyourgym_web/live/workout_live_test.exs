defmodule AllyourgymWeb.WorkoutLiveTest do
  use AllyourgymWeb.ConnCase

  import Phoenix.LiveViewTest
  import Allyourgym.FitnessFixtures

  @create_attrs %{name: "some name", description: "some description", is_public: true, notes: "some notes"}
  @update_attrs %{name: "some updated name", description: "some updated description", is_public: false, notes: "some updated notes"}
  @invalid_attrs %{name: nil, description: nil, is_public: false, notes: nil}
